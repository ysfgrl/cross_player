...
var dm = document.location.hostname.toLowerCase(), dm2 = window.location.hostname.toLowerCase(),
...
!function (e, t) {
    ...
    function n(t, s) {
        var i = t.tech_, n = new Array, a = e.mergeOptions({
            videoInfo: !1,
            infoSize: 18,
            infoBold: !1,
            infoAlign: "left",
            ...
            metatitle: "",
            metasubtitle: ""
        }, s), r = t.el(), l = 0, o = 0, d = 0, v = 1;
        a.isAddon = !1, a.newstate = 4, a.oldstate = 4, a.events = {};
        var c, u = t.id(), h = (r = t.el(), !1), f = (i = t.$(".vjs-tech"), this), j = new Array,
        ...
        if (!0 === p) {
            ...
            var y = "pictureInPictureToggle", b = !0, C = vjs_find(r, ".vjs-picture-in-picture-control");
            ...
            var A = t.controlBar.addChild("button", {
                el: e.dom.createEl("div", {className: "vjs-quality-button vjs-menu-button vjs-menu-button-popup vjs-control vjs-button vjs-hidden"}, {
            ...
            if (vjs_find(r, ".vjs-quality-button").innerHTML = '<button class="vjs-quality-button vjs-menu-button vjs-menu-button-popup vjs-button"><span></span></button><div class="vjs-menu"><ul class="vjs-menu-content vjs-qlist" role="menu"></ul></div>', a.buttonForward) {
                ...
                var x = t.controlBar.addChild("button", {
                    el: e.dom.createEl("button", {className: "vjs-forward-control vjs-control vjs-button"}, {
            ...
            var w = e.dom.createEl("div", {className: "vjs-vast-label"});
            ...
            var T = t.controlBar.addChild("button", {
                el: e.dom.createEl("div", {className: "vjs-control vjs-button vjs-cog-menu-button vjs-hidden"}, {
            ...
            if (a.theaterButton) {
                var I = t.controlBar.addChild("button", {
                    el: e.dom.createEl("div", {className: "vjs-control vjs-button vjs-control-button vjs-mode-control"}, {
            ...
            var L = vjs_El("div", "vjs-menu-settings vjs-hidden"), M = vjs_El("div", "vjs-menu-div vjs-settings-div");
            L.appendChild(M);
            ...
            if ("" == a.title && (a.title = a.metatitle = document.title), "" == a.infoText && (a.infoText = a.metatitle), 1 != a.errordisplay && vjs_addClass(vjs_find(r, ".vjs-error-display"), "vjs-abs-hidden"), 1 != a.timetooltip) {
                var H = vjs_find(r, ".vjs-play-progress"), D = vjs_find(H, ".vjs-time-tooltip");
            ...
            if (a.contextMenu) {
                ...
                function O() {
                    ...
                    q.innerHTML = N, t.el().appendChild(q), r.addEventListener("contextmenu", function (t) {
                        ...
                        var s = q.offsetWidth, i = q.offsetHeight;
                        if (t.clientY) var n = t.clientY; else n = null;
                        if (t.clientX) var l = t.clientX; else l = null;
                        if (vjs_find(r, ".ctxt").onclick = function (e) {
                            a.waslink = !0
                        }, null !== n && null !== l) {
                            var o = r.getBoundingClientRect(), d = n - o.top, v = l - o.left;
            ...
            if ("treso" == e.options.skinname) {
                var U = vjs_find(r, ".vjs-current-time"), F = vjs_find(r, ".vjs-duration"),
            ...
            t.resetNuevo = function (s) {
                ...
                var d = t.tech({IWillNotUseThisInPlugins: !0}).el();
                if (!0 !== e.browser.IS_IOS) for (; d.firstChild;) d.removeChild(d.firstChild);
                if (1 == n.length && t.src(n), n.length > 1) {
                    ...
                    if (u >= a.minResolution) {
                        ...
                        var f, p = new Array, m = new Array, g = new Array, _ = "", y = "", b = 0, C = 0, A = 0, x = 0,
                            k = 0, w = !1, T = "MediaSource" in window;
                        for ((Z = ["iPad", "iPhone", "iPod"].indexOf(navigator.platform) >= 0) && (T = !1), Z && 1 == o.length && (T = !0); b < o.length; b++) {
                            ...
                            if ("" != D && (-1 === D.indexOf("mpeg") && -1 === D.indexOf("apple") || (a.hls = !0), -1 !== D.indexOf("dash") && (a.dash = !0)), o[b].res && o[b].label) {
                                ...
                                E = o[b].type;
                                if (o[b].default) ; else ;
                                -1 !== E.indexOf("mpeg") || -1 !== E.indexOf("apple") ? (p[C] = o[b], ++C > 1 && (a.hls = !0, a.hlsQualities = !1)) : -1 !== E.indexOf("dash") ? (m[A] = o[b], ++A > 1 && (a.dash = !0, a.dashQualities = !1)) : (g[x] = o[b], x++)
                            }
                        }
                        var I = new Array;
                        ...
                        if (k > 1) {
                            ...
                            function X(e) {
                                var s = t.currentTime(), i = t.paused();
                ...
                if (t.on("loadeddata", function () {
                    if (a.chapterMarkers) {
                        var e = !1, s = t.textTracks();
                        if (s.length > 0) for (var i = 0; i < s.length; i++) if ("chapters" == s[i].kind && 1 != e) {
                            e = !0;
                            var n = s[i]
                        }
                        if (n) {
                            vjs_addClass(vjs_find(r, ".vjs-mouse-display"), "vjs-abs-hidden");
                            var o = n.cues, d = [], v = vjs_find(r, ".vjs-progress-holder"), u = t.duration();
                            for (i = 0; i < o.length; i++) if (o[i].startTime > 0) {
                                d[i] = o[i].startTime;
                                var h = vjs_El("div", "vjs-marker"), f = vjs_El("div", "vjs-marker-inn"),
                                ...
                                h.appendChild(f), h.appendChild(p), p.innerHTML = o[i].text, h.style.left = d[i] / u * 100 + "%", v.appendChild(h), h.onmouseenter = function () {
                                    var e = this.offsetLeft, t = vjs_find(this, ".vjs-marker-tooltip"),
                                        s = t.offsetWidth / 2, i = vjs_find(r, ".vjs-progress-control"),
                                        n = (i.offsetLeft, i.offsetWidth), a = -1 * e + s,
                    ...
                    if (T && 1 != Z) try {
                        t.tech_.hls.representations().forEach(function (e) {
                            var s = new Object, i = t.tech_.hls.selectPlaylist();
                    ...
                    m.length > 0 && (ee(), l = m.length, !0, !0, j = m, function (e, s, i, n) {
                        if (j.length < 2) ee(); else {
                            for (var l = !0, o = 0, d = 0, v = !1, c = 0, u = j.length; c < u; c++) if (j[c].height > 0 && o++, j[c].bitrate > 0 && d++, j[c].duplicate = !1, j[c].height > 0 && 1 != v) {
                                var h = 0, f = 0;
                            ...
                            var b, C = new Array, A = new Array, x = new Array;
                            for (c = 0, u = j.length; c < u; c++) {
                                var k = "", w = parseInt(j[c].height);
                                if (a.hdicon) {
                                    var T = "HD";
                            ...
                            var S = vjs_mfind(r, ".item-quality"), q = vjs_mfind(r, ".full-quality");
                            for (le("auto", "Auto"), ie(), a.menutouch = !1, re(), c = 0; c < S.length; c++) {
                                ...
                                var N = function (s) {
                                    ...
                                    var d = s.target, v = d.getAttribute("data-id"), c = d.getAttribute("data-res"),
                                    ...
                                    if (vjs_find(r, ".vjs-quality-button .vjs-menu").style.display = "none", vjs_addClass(vjs_find(r, ".vjs-back-res"), "vjs-hidden"), "dash" == e) {
                                        ...
                                        if (v == c || parseInt(e.bandwidth / 1e3) == parseInt(v)) {
                                            var s = parseInt(e.bandwidth / 1e3), i = parseInt(v);
                ...
                if (0 != a.videoInfo && ("" != a.infoText || "" != a.title)) {
                    var $ = !1, te = a.url || document.location.href, se = vjs_El("span", "vjs-info"), ne = "";
            ...
            if ((X = t.options_.sources).length > 0) {
                ...
                -1 !== D.indexOf("dash") && K && t.src(X), t.resetNuevo(!1), de()
            ...
            if (t.reconnect = function () {
                ...
                if (a.title = "", a.metatitle = "", a.metasubtitle = "", e) {
                    ...
                    if (e.sources) {
                        ...
                        if ("video/mp4" != e.sources[0].type && e.sources[0].type, t.resetNuevo(!0, e), void 0 !== e.tracks) for (l = e.tracks, s = 0; s < l.length; s++) "undefined" != l[s].src && (l[s].default && (l[s].mode = "showing", t.currentTrack = l[s].src), t.addRemoteTextTrack(l[s], !1)); else void 0 !== e.track && "undefined" != track.src && (e.track.mode = "showing", t.addRemoteTextTrack(e.track, !1));
                        a.infoText = a.metatitle, void 0 !== e.url && (a.url = e.url)
                    }
                }
            }, t.on("playlistready", function () {
                a.playlistRepeat && t.playlist.repeat(!0), function () {
                    ...
                    if (1 != a.playlist) {
                        ...
                        if (a.playlistUI) {
                            var o = e.dom.createEl("div", {className: "vjs-playlist-button"}, {title: "Playlist"});
                            ...
                            for (f = 0; f < h.length; f++) {
                                ...
                                var g = vjs_El("p");
                                if (h[f].title) g.innerHTML = h[f].title; else {
                                    var _ = h[f].sources[0].src, y = _.substring(_.lastIndexOf("/") + 1);
                                    if (h[f].sources.length > 0) for (j = 0; j < h[f].sources.length; j++) if (h[f].sources[j].default) {
                    ...
                    t.on("playlist_newitem", function (e, s) {
                        ...
                        if (a.playlistUI) for (var n = vjs_mfind(r, ".vjs-vlist .vjs-item"), l = 0; l < n.length; l++) vjs_remClass(n[l], "vjs-active-item");
                        t.on("play", function () {
                            if (a.playlistUI) {
                            ...
                            if (a.playlistNavigation) {
                                t.playlist.repeat();
                                var l = vjs_find(r, ".vjs-nav-prev"), o = vjs_find(r, ".vjs-nav-next");
                ...
                c.addEventListener(setEvent("mousedown"), function (e) {
                    e.preventDefault(), a.seeking = !0, e.stopPropagation(), function (e) {
                        var s = -1, i = t.duration();
                        if (i > 0) {
                            ...
                            if (s) {
                                var a = (s -= n.left) / (n.right - n.left), r = i * a;
                                t.currentTime(r)
                            }
                        }
                    }(e)
                ...
                function p() {
                    if (a.resume && "" != a.video_id && localStorage && localStorage.vjs_resume) {
                        ...
                        if (2 == e.length) if (e[0] == a.video_id && Number(e[1]) > 3) {
                            var s = Number(e[1]);
                            setTimeout(function () {
                        ...
                        if (a.limit > 0 && ("" != a.limiturl || "" != a.url)) {
                            ...
                            t.on("timeupdate", function () {
                                if (t.currentTime() > a.limit && (t.pause(), _.style.display = "none", 1 != s)) {
                                    s = !0;
                                    var e = vjs_El("div", "vjs-limit-overlay"), i = vjs_El("a", "vjs-limit");
                        ...
                        if ((a.relatedMenu || a.shareMenu || a.rateMenu || a.zoomMenu) && (i = !0), i) {
                            ...
                            if ("" != n) {
                                ...
                                for (var j = function (e) {
                                    ...
                                    var s = e.target.innerHTML, i = (s = s.replace("x", "")) + "x";
                            ...
                            if (a.related.length > 1 && a.relatedMenu) {
                                var y = a.related.length, b = vjs_El("div"), C = !1;
                                ...
                                o = 1;
                                for (g = 0; g < y; g++) {
                                    var M = vjs_El("div", "rel-parent"), P = vjs_El("div", "rel-item");
                                ...
                                var D = function (e) {
                                    if (e.preventDefault(), e.stopImmediatePropagation(), !vjs_hasClass(vjs_find(r, ".vjs-arrow-prev"), "vjs-disabled")) {
                                        var t = vjs_find(r, ".vjs-related").offsetWidth, s = ((o -= 1) - 1) * t;
                            ...
                            if (a.shareMenu) {
                                var z = vjs_El("div", "vjs-sharing-overlay vjs-hidden"),
                                    S = vjs_El("div", "vjs-sharing-container"), q = vjs_El("div", "vjs-sharing-body"),
                                    N = a.url || document.location.href, O = a.embed || "N/A",
                            ...
                            if (a.zoomMenu) {
                                ...
                                if (vjs_remClass(J, "vjs-hidden"), J.setAttribute("style", ""), J.style.display = "inline-block", J.style.opacity = 0, e.browser.TOUCH_ENABLED && (vjs_find(r, ".vjs-tech").style.pointerEvents = "none"), a.zoomInfo) {
                                    ...
                                    var $ = vjs_El("div", "vjs-reset-center"), ee = vjs_El("div", "vjs-reset-cancel");
                                ...
                                if (oe.hasAttribute("tabIndex") || oe.setAttribute("tabIndex", "-1"), oe.style.outline = "none", a.zoomWheel) {
                                    if (e.browser.TOUCH_ENABLED) {
                                        var de = vjs_El("div", "vjs-zoom-slide"), fe = vjs_El("div", "zoom-bg"),
                                ...
                                function be(e) {
                                    if (e.preventDefault(), K) {
                                        try {
                                            X = {x: event.clientX, y: event.clientY}
                                        } catch (e) {
                                        }
                                        try {
                                            X = {x: event.touches[0].clientX, y: event.touches[0].clientY}
                                        } catch (e) {
                                        }
                                        var t = vjs_find(r, ".vjs-tech"), s = X.x + Z[0], i = X.y + Z[1],
                                            n = r.offsetWidth / 2 * (v - 1), a = r.offsetHeight / 2 * (v - 1);
                                ...
                                function Ae(s, i) {
                                    ...
                                    if (0 != n) {
                                        var a = i.offsetHeight, l = n - function (e) {
                                            var t = e.offsetTop;
            ...
            var J = i.getAttribute("poster"), G = vjs_El("div", "vjs-lcn");
        ...
        function $(s) {
            ...
            var n = t.controlBar.addChild("button", {
                el: e.dom.createEl("button", {className: i + " vjs-control vjs-button"}, {
        ...
        function ie() {
            var e = vjs_find(r, ".vjs-menu-settings"), t = vjs_find(r, ".vjs-quality-button"),
            ...
            var o = vjs_find(r, ".vjs-settings-div"), d = vjs_find(r, ".vjs-menu-speed"),
                c = vjs_find(r, ".vjs-zoom-menu"), u = vjs_find(r, ".vjs-settings-home"),
            ...
            if (h) {
                ...
                var m = function (e) {
                    ...
                    var t = vjs_find(r, ".vjs-menu-settings"), s = window.getComputedStyle(t);
            ...
            var x = vjs_find(r, ".vjs-cog-menu-button"), k = function (e) {
        ...
        function ne() {
            ...
            if (e.browser.IS_TOUCH_ENABLED) var s = .9; else s = .8;
            if (vjs_find(r, ".rel-block")) {
                vjs_remClass(vjs_find(r, ".rel-block"), "rel-anim");
                var i = r.offsetWidth, n = r.offsetHeight, l = i * s;
                l > 800 && (l = 800);
                ...
                var f = l / u * .5625, j = l / u, p = Math.ceil(t / 6);
                ...
                if (c.style.top = n / 2 - f * h / 2 + "px", c.style.left = i / 2 - l / 2 + "px", 1 != e.browser.TOUCH_ENABLED) {
                    var g = vjs_find(r, ".vjs-arrow-prev"), _ = vjs_find(r, ".vjs-arrow-next"),
        ...
        function ae() {
            if (r.offsetHeight < 300) {
                var e = vjs_find(r, ".vjs-quality-button"), t = vjs_find(e, ".vjs-menu");
        ...
        function re() {
            var e = vjs_find(r, ".vjs-menu-speed"), t = vjs_find(r, ".vjs-zoom-menu"),
                s = vjs_find(r, ".vjs-menu-quality"), i = vjs_find(r, ".vjs-settings-div"),
            ...
            var l = !1, o = vjs_find(r, ".vjs-menu-settings");
        ...
        function ve() {
            var s = vjs_find(r, ".vjs-mouse-display"), i = vjs_find(r, ".vjs-progress-slide");
            if (i && i.parentNode.removeChild(i), "" != a.slideImage && !0 !== e.browser.TOUCH_ENABLED && s) {
                var n = vjs_El("div", "vjs-progress-slide"), l = vjs_El("div", "vjs-thumb"),
                    o = vjs_El("div", "vjs-thumb-duration"), d = vjs_El("img");
                ...
                v.src = a.slideImage, v.onload = function () {
                    var s = vjs_find(r, ".vjs-play-progress"), i = vjs_find(s, ".vjs-time-tooltip");
                    vjs_addClass(i, "vjs-abs-hidden"), vjs_addClass(vjs_find(r, ".vjs-mouse-display"), "vjs-abs-hidden");
                    var v = this.width, c = this.height, u = v / a.slideWidth;
                    ...
                    vjs_find(r, ".vjs-progress-holder").onmousemove = function (s) {
                        vjs_find(r, ".vjs-tech-chromecast") || vjs_find(r, ".vjs-progress-slide") && function (s) {
                            ...
                            var h = Number(v) / Number(i), f = e.options.skinname,
        ...
        function he() {
            var e = (v - 1) / 4 * 100, t = vjs_find(r, ".zoom-thumb");
            t && (t.style.height = e + "%")
        }
    ...
    var t = !1, s = function (e) {
        ...
        return s.playlistItemId_ && (e.playlist.currentPlaylistItemId_ = s.playlistItemId_), e.changeSrc(s), 1 != t ? t = !0 : e.trigger("playlist_change"), e.ready(function () {
            if (e.trigger("playlistitem", s.originalValue || s), e.trigger("playlist_newitem", {id: s.playlistItemId_}), n) {
                var t = e.play();
    ...
    var v = function (t, v) {
        this.ready(function () {
            !function (t, v, c) {
                void 0 === c && (c = 0);
                var u = null, h = !1, f = t.playlist = function (e, s) {
                    if (void 0 === s && (s = 0), h) throw new Error("do not call playlist() during a playlist change");
                    if (Array.isArray(e)) {
                        var i = Array.isArray(u) ? u.slice() : null, n = e.slice();
                        (u = n.slice()).filter(function (e) {
                            return a(e)
                        }).length !== u.length && (u = r(u)), l(u), h = !0, t.trigger({previousPlaylist: i || []}), h = !1, -1 !== s && f.currentItem(s), i && t.setTimeout(function () {
                ...
                t.on("loadstart", function () {
                    ...
                    if (f.currentPlaylistItemId_) {
                        var s = o(u, f.currentPlaylistItemId_), i = u[s];
